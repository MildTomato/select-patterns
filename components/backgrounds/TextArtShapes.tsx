...
// Text-art rows with a macro layer on top: large shapes built from one
// repeated big character each, interweaving and drifting in and out of
// the canvas over the fine glyph field.
const N_COLORS = 4
const QL = 32
const UNIT = 12
...
export default function TextArtShapes() {
