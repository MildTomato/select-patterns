...
// Light theme — cream background, shapes go from near-white to near-black
const SHADES = ["#e8e4df", "#c0b8b0", "#8a8078", "#3d3730", "#1a1410"]
...
export default function MiniGridLight() {
