...
function symAt(col:number,row:number){ const h=((col*2654435761)^(row*2246822519))>>>0; return SYMBOLS[h%SYMBOLS.length] }

export default function DitherSymbols() {
