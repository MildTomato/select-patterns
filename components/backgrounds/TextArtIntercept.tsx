...
// Text-art rows intercepted by large character-shapes: where a big shape
// passes, the normal row cells drop out and the shape's repeated character
// takes their place — one surface, mutually exclusive regions.
const N_COLORS = 4
const QL = 32
const UNIT = 12
...
export default function TextArtIntercept() {
